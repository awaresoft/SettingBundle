 ...
 * })
 *
 * @ORM\Entity(repositoryClass="Awaresoft\SettingBundle\Entity\Repository\SettingHasFieldRepository")
 *
 * @UniqueEntity({"setting", "name"})
 *
 * @author Bartosz Malec <b.malec@awaresoft.pl>
 */
class SettingHasField
{
    /**
     * @ORM\Id
